#!/bin/bash
# AstroUniverse 2026 - Linux Release Build (Docker / Ubuntu 20.04)
...
IMAGE_NAME="astrouni2026-build-ubuntu2004"
...
echo "=== AstroUniverse 2026 - Linux Release Build (Docker / Ubuntu 20.04) ==="
...
echo "  $SCRIPT_DIR/astrouni2026/dist/"
