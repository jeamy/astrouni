...
- [x] **Personen-Dialog**: Basis-Implementierung (`PersonDialog`) erstellt und `assert`-Fehler beim Sizer-Layout behoben.
- [x] **Orte-Dialog**: Basis-Implementierung (`OrtDialog`) erstellt und integriert.
